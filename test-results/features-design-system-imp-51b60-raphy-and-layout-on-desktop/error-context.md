...
Error: expect(page).toHaveScreenshot(expected)
  ...
  Expected an image 1440px by 900px, received 1440px by 3321px. 4647710 pixels (ratio 0.98 of all image pixels) are different.

Expected: C:\Projects\Raw Alpha v2\static-site\tests\features\design-system-implementation\visual-regression.spec.js-snapshots\homepage-typography-layout-desktop-win32.png
