...
- Name: Design System Visual Regression >> should visually match the baseline for component default states
- Location: C:\Projects\Raw Alpha v2\static-site\tests\features\design-system-implementation\visual-regression.spec.cjs:29:7
...
Expected: C:\Projects\Raw Alpha v2\static-site\tests\features\design-system-implementation\visual-regression.spec.cjs-snapshots\homepage-components-default-states-win32.png
Received: C:\Projects\Raw Alpha v2\static-site\test-results\features-design-system-imp-aeb75-or-component-default-states\homepage-components-default-states-actual.png
    Diff: C:\Projects\Raw Alpha v2\static-site\test-results\features-design-system-imp-aeb75-or-component-default-states\homepage-components-default-states-diff.png

Call log:
  - expect.toHaveScreenshot(homepage-components-default-states.png) with timeout 5000ms
  ...
  - 2099 pixels (ratio 0.01 of all image pixels) are different.
    ...
    at C:\Projects\Raw Alpha v2\static-site\tests\features\design-system-implementation\visual-regression.spec.cjs:33:24
```
